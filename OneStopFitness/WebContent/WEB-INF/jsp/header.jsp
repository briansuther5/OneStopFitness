	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
			    ...
			    <a class="navbar-brand" rel="home" href="${pageContext.request.contextPath}/controller/summary/view">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="${pageContext.request.contextPath}/controller/summary/view"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
				...
				<ul class="nav navbar-nav navbar-right" style="padding-right:10px;">
					<li><a href="${pageContext.request.contextPath}/controller/calendar/view"><span class="glyphicon glyphicon-calendar"></span></a></li>
					<li class="dropdown">
