            ...
            <div class="well well-sm">
                <form class="form-horizontal" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center hidden-xs hidden-sm"><i class="fa fa-phone-square bigicon"></i></span>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center hidden-xs hidden-sm"><i class="fa fa-pencil-square-o bigicon"></i></span>
                            <div class="col-md-8">
